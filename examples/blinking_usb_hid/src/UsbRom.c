...
uint8_t StringDescriptor[] = {
	...
	WBVAL('L'), WBVAL('P'), WBVAL('C'), WBVAL('U'), WBVAL('S'), WBVAL('B'), WBVAL('l'), WBVAL('i'), WBVAL('b'), WBVAL(
		' '),
	WBVAL('G'), WBVAL('e'), WBVAL('n'), WBVAL('e'), WBVAL('r'), WBVAL('i'), WBVAL('c'), WBVAL(' '), WBVAL('H'), WBVAL(
		'I'), WBVAL('D'), WBVAL(' '),
...
{
	CALLBACK_HID_Device_ProcessHIDReport(&Generic_HID_Interface, 0, 0, *reportoutbuffer, reportoutsize);
