/*
 * @brief Generic HID device class declarations, definitions for using in application
 *
 * @note
...
#include "../../../externals/usblib/inc/Drivers/USB/USB.h"
#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup Generic_HID_Device_Descriptor Class descriptors
